        ...
        <div class="form">
            ...
            <div class="form-control">
                ...
                <div class="form-input">
                    <input type="text" id="phone" v-model="phone" @change="checkPhone" placeholder="输入11位手机号，仅用于找回支付密码">
                </div>
            </div>
            ...
            <div class="form-control">
                <label for="passwordF" class="form-label">新密码</label>
                <div class="form-input">
                    <input type="password" id="passwordF" v-model="passwordF" placeholder="设置新的余额支付密码">
                </div>
            </div>
            <div class="form-control">
                <label for="passwordS" class="form-label">重复新密码</label>
                <div class="form-input">
                    <input type="password" id="passwordS" v-model="passwordS" @change="check" placeholder="确认新的余额支付密码">
                </div>
            </div>
            <div class="form-control">
...
<script>
import { resetPayPassWord , getCodeByPhone } from '@/utils/ApiList.js'
...
export default {
    data() {
        return {
            ...
            // card_no: window.localStorage.getItem('CARD_ID') || '',      //卡号
        ...
        setPassword: function() {
            ...
            if (that.cardId=='') {
                ...
                if (that.smsCode ==''){
					...
					uni.request({
						url: baseUrl+'wx/modify_pay_password',
						data: {
							card_no: that.cardId,
